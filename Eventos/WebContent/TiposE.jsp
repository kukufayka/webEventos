...
<body>
  ...
  <div class="row">
    <div class="col-sm-4">
      <img src="img/conciertos.jpg" class="img-responsive" style="width:100%" alt="Image">
      <p><a href="" >Conciertos</a></p>  
    </div>
    <div class="col-sm-4"> 
      <img src="img/Museo-Ciencia.jpg" class="img-responsive" style="width:100%" alt="Image">
      <p><a href="" >Museos</a></p>    
    </div>
    <div class="col-sm-4"> 
      <img src="img/21-TeatroCalderon.jpg" class="img-responsive" style="width:100%" alt="Image">
